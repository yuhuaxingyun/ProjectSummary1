...
-(id) initWithFrame:(CGRect) frame Titles:(NSArray *) titles{
    if (self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, 85)]) {
        [self setBackgroundColor:[UIColor colorWithRed:249/225.0 green:249/225.0 blue:249/225.0 alpha:1.0]];
