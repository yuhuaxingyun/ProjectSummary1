...
#import "UIImage+SJCompress.h"
#import <Photos/Photos.h>
@implementation UIImage (SJCompress)
...
+ (UIImage *)resizableImage:(NSString *)name
{
    ...
    return [normal resizableImageWithCapInsets:UIEdgeInsetsMake(h*2-2, w*2-10, h*2 -2, w*2-10)];
}
