...
#import "SJAVPlayerController.h"

@interface SJAVPlayerController ()<LRLAVPlayDelegate, AVPictureInPictureControllerDelegate>
...
@implementation SJAVPlayerController
...
-(void)createAVPlayerView{
    //固定的实例化方法
    self.avplayerView = [LRLAVPlayerView avplayerViewWithVideoUrlStr:@"http://v.baidu.com/watch/4485001169735699374.html?&recFrom=site&framehost=baidu.aipai.com&referer=http://baidu.aipai.com/watch/4485001169735699374.html&inner" andInitialHeight:200.0 andSuperView:self.view];
    self.avplayerView.delegate = self;
    [self.view addSubview:self.avplayerView];
    __weak SJAVPlayerController * weakSelf = self;
